...
--- Takes as param enum detectionType1, enum detectionType2, ...
---@param detectionType Controller.Detection
---@return table
function Controller:getDetectedTargets(detectionType) end